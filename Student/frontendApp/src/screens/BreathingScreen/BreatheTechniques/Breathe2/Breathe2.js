...
const Breathe2 = () => {
  ...
  const playSound = () => {
    if (!sound.current) {
      sound.current = new Sound('breathe2.mp3', Sound.MAIN_BUNDLE, (error) => {
        if (error) {
  ...
  return (
    <View style={{ height: height * 0.7, width: width }}>
      ...
      <TouchableOpacity onPress={Breathe1}>
        ...
        <Text style={{ padding: 2, color: 'white', backgroundColor: '#96C291', borderRadius: width / 2, padding: 15 }}>
      ...
      <AnimatedTypewriterText
        sentences={[
          ...
          '2.Keeping your mouth closed, inhales slowly through your nose for 2 counts.',
